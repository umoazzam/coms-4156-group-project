...
public class Book {
     ...
     * Required field for citation generation.
     */
     ...
     *
     * @return The book's unique ID, or null if not yet persisted
     */
    public Long getId() {
        return id;
    }
     ...
     * Typically called by the persistence framework.
     *
     ...
     *
     * @param title The title to set (required field)
     ...
     *
     * @param author The author to set (required field)
